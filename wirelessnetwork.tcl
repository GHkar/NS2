...
#1 - initialie variables
#2 - Create a Simlator object
#3 - Create a Tracing and animation file
#4 - Topography
...
#9 - Any mobility code (if the nodes ar moving)
#10 - TCP, UDP Traffic
# run the simulation
...
set n3 [$ns node]
set n4 [$ns node]
#$ns node-config -channel $channel3
set n5 [$ns node]			
...
$n5 set Y_ 120.0
$n5 set Z_ 0.0
# Don't mention any values above than 500 because in this example, we use X and Y as 500, 500
